...
function validateForm(event) {
    ...
    const payMethod = document.querySelector('#paymentMethod');
    payMethod.addEventListener('change', togglePaymentDetails)
  ...
  function togglePaymentDetails(e) {
    ...
    const value = e.target.value //theForm.paymentMethod.value
  
    // if cc -> show cc remove req pp
    // else if pp -> show pp remove req cc
